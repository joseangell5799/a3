...
<head>
  ...
  <title>HUCKLEBERRY YUM | Flagship Atelier</title>
...
<header class="site-header">
  <div class="container header-inner">
    <a href="index.php" class="brand-logo">HUCKLEBERRY YUM</a>
...
<div class="mobile-drawer" id="mobile-drawer">
  <div class="drawer-header">
    <span class="brand-logo">HUCKLEBERRY YUM</span>
  ...
  <section class="section-pad">
    <div class="container">
      <div class="section-header">
        ...
        <p style="color:var(--text-secondary);">Tailored commissions engineered for connoisseurs of Wild Mountain Huckleberry Preserves & Botanical Gastronomy.</p>
      </div>
      <div class="grid-2">
  ...
  <section class="section-pad" style="background:var(--bg-surface); border-top:1px solid var(--border-subtle); border-bottom:1px solid var(--border-subtle);">
    <div class="container" style="display:grid; grid-template-columns:1fr 1.1fr; gap:4rem; align-items:center;">
      ...
      <div>
        ...
        <p style="color:var(--text-secondary); line-height:1.8; margin-bottom:1.5rem;">Since our founding at 181 Mercer Street, Huckleberry Yum has stood as a bastion of tactile discipline. While commercial entities pursue automated shortcuts, our workshop remains committed to the slow, meditative cadence of traditional hand finishing.</p>
        ...
        <table class="spec-table">
          <thead>
            <tr>
              ...
              <th>Our Flagship Atelier (HUCKLEBERRY YUM)</th>
            </tr>
          </thead>
          <tbody>
            <tr>
  ...
  <section class="section-pad" style="background:var(--bg-surface); border-top:1px solid var(--border-subtle); border-bottom:1px solid var(--border-subtle);">
    <div class="container">
      <div class="section-header">
        ...
        <p style="color:var(--text-secondary);">Unsolicited feedback from patrons who demand uncompromised excellence in Wild Mountain Huckleberry Preserves & Botanical Gastronomy.</p>
      </div>
      <div class="grid-3">
        <div class="quote-card">
          <p class="quote-text">"The bespoke execution delivered by Huckleberry Yum is extraordinary. The tactile feel and flawless balance prove their unwavering adherence to classical hand methods."</p>
...
<footer class="site-footer">
  <div class="container">
    ...
    <div class="footer-bottom">
      <span>&copy; 2026 HUCKLEBERRY YUM. All rights reserved. Certified Handcrafted Static Architecture.</span>
